...
namespace /***$rootnamespace$.***/ULibs.Win32
{
    internal static class User32
    {
        ...
        [DllImport("user32.dll", SetLastError = true)]
        internal static extern IntPtr TrackPopupMenuEx(IntPtr hmenu, TPM fuFlags, int x, int y, IntPtr hwnd, IntPtr lptpm);
        ...
        internal static void ModifyStyle(IntPtr hwnd, WS removeStyle, WS addStyle)
        {
        ...
        [DllImport("user32.dll")]
        internal static extern IntPtr MonitorFromWindow(IntPtr handle, MONITOR flags);
        ...
        internal static extern uint SetClassLongPtr32(IntPtr hWnd, int nIndex, int dwNewLong);
        ...
        internal static IntPtr SetClassLongPtr(IntPtr hwnd, int nIndex, IntPtr dwNewLong)
        {
        ...
        internal static void ModifyClass(IntPtr hwnd, CS removeClass, CS addClass)
        {
        ...
        [DllImport("user32.dll")]
        internal static extern IntPtr CreateWindowEx(WS_EX dwExStyle, string lpClassName, string lpWindowName, WS dwStyle, 
        ...
        [DllImport("user32.dll")]
        internal static extern bool UpdateLayeredWindow(IntPtr hwnd, IntPtr hdcDst, ref POINT pptDst, ref SIZE psize, IntPtr hdcSrc, ref POINT pptSrc, COLORREF crKey, ref BLENDFUNCTION pblend, ULW dwFlags);

        [DllImport("user32.dll")]
        internal static extern bool SetLayeredWindowAttributes(IntPtr hwnd, COLORREF crKey, byte bAlpha, LWA dwFlags);
        ...
        internal static extern IntPtr LoadImage(IntPtr hinst, string lpszName, IMAGE uType, int cxDesired, int cyDesired, LR fuLoad);

        [DllImport("user32.dll", EntryPoint = "LoadImage", SetLastError = true)]
        internal static extern IntPtr LoadImage(IntPtr hinst, IntPtr lpszName, IMAGE uType, int cxDesired, int cyDesired, LR fuLoad);
